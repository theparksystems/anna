...
void ArrangementTimelineComponent::mouseDown (const juce::MouseEvent& event)
{
    ...
    if (hit.clipId != kInvalidClipId)
    {
        ...
        projectController.beginEdit ("Move arrangement clip");
        dragEditOpen = true;
...
void ArrangementTimelineComponent::mouseDrag (const juce::MouseEvent& event)
{
    ...
    projectController.previewArrangementClipMove (dragClipId, newStart);
    repaint();
...
void ArrangementTimelineComponent::mouseUp (const juce::MouseEvent& event)
{
    ...
    {
        dragEditOpen = false;
        projectController.endEdit();
    }

    dragClipId = kInvalidClipId;
    dragStartBar = 0.0;
    dragPointerOffsetBars = 0;
}
