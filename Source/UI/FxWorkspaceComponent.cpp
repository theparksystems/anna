      ...
      reverbPanel (store)
{
    ...
    colorPanel.setChangeCallback (notify);
    ...
    fxTabs.addTab ("Color", SamprLookAndFeel::panel(), &colorPanel, false);
...
void FxWorkspaceComponent::syncEditors()
{
    ...
    colorPanel.setChannel (channelIndex);
