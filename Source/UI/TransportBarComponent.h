...
public:
    ...
    using SoundCloudExportCallback = std::function<void()>;
    ...
    void setSoundCloudExportCallback (SoundCloudExportCallback callback);
...
private:
    ...
    juce::TextButton soundCloudButton { "SC Ready" };
    ...
    SoundCloudExportCallback onSoundCloudExport;
